...
Upload a screenshot named dashboard-preview.png
Then use this line below:
...
Use Pivot controls to explore the data.

Modify filters to analyze different segments.
